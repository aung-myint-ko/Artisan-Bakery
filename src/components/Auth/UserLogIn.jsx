...
function UserLogIn(props) {
  ...
  const OnSubmit = async (formData) => {
    try {
      ...
      const request = await axios.post("/auth/signin", formData);
            ...
            <div className=" sm:w-[75%] lg:w-[60%] sm:py-10 lg:py-0 grid grid-cols-1 lg:grid-cols-2 sm:bg-slate-50 lg:bg-white sm:border sm:shadow-md z-50 ">
              <div className=" lg:bg-[#b15412] lg:text-white px-4 sm:px-7  flex flex-col justify-center ">
                ...
                <div className="hidden lg:block text-center mb-9">
                  ...
                  <p className=" text-xs">
                    ...
                    you pay. Get access to mobile ordering, a birthday Reward,
                    and more.
                  </p>
                </div>
              ...
              <div className=" px-4 sm:px-10 md:px-20 lg:px-6 py-7 lg:py-8">
                ...
                <form onSubmit={handleSubmit(OnSubmit)} action="">
                  <div className="flex flex-col gap-y-6 lg:gap-y-4 mb-7">
                    <div>
                      <label className=" text-lg lg:text-xl" htmlFor="">
                        Email
                      </label>
                      <input
                        {...register("email")}
                        className=" w-full outline-none border-b text-sm pt-1 pb-[1px] sm:bg-slate-50 lg:bg-white text-gray-700"
                        type="email"
                        autoFocus
                        required
                      />
                  ...
                  <button
                    type={"submit"}
                    className=" button mx-auto mb-4 lg:mb-6"
                  >
                    Log In
                  </button>
                </form>
